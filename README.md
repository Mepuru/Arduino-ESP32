...
### [cs2_bomb](04_cs2_bomb/) — C4 炸弹模拟器 (Web + 蜂鸣器)

ESP32-S3 + ST7789 + 蜂鸣器，Web 页面控制的下包/拆包倒计时模拟器。

| | |
|---|---|
| **核心** | Web Server + TFT_eSPI + Buzzer |
| **接线** | CS=10, DC=5, RST=6, MOSI=11, SCLK=12, BL=21, Buzzer=GPIO4 |
| **要点** | 密码鉴权下包/拆包，蜂鸣器随倒计时变速报警 |
| **演示** | ST7789 倒计时大屏、Web 下包/拆包控制、蜂鸣器节奏变化、进度条颜色渐变 |
